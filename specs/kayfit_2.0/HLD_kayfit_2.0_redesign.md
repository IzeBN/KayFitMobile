...
## Статус реализации (обновлено 2026-05-07)

| Слой | Статус | Примечания |
|---|---|---|
| Дизайн-токены KF2 (`kayfit2_theme.dart`) | ✅ Готов | Light + dark, Apple ring colors |
| `KayfitRings` widget | ✅ Готов | CustomPainter, 4 кольца |
| `CalendarStrip` (week + month) | ✅ Готов | |
| `Kayfit2TabBar` | ✅ Готов | |
| `JournalV2Screen` | ✅ Готов | Feature flag `KF2_JOURNAL` |
| `ChatV2Screen` | ✅ Готов | |
| `RecognitionV2Screen` | ✅ Готов | Capture / recognizing / preview |
| Preview & Edit + AI-correct | ✅ Готов | |
| Chat AI pipeline (streaming) | 🔲 Backlog | Пока симулируется на фронте |
| Routing (drop dashboard) | ✅ Готов | Feature flag `KF2_JOURNAL` |
| Fonts (Geist + JetBrains Mono) | ✅ Готов | |
| Cleanup старых экранов | 🔲 Backlog | Dashboard скрыт флагом, не удалён |

**Pre-release sprint (2026-05-07):** онбординг переведён на синюю палитру, исправлен баг веса, AI Consent H-5, App Store сборка.  
Детали: [`specs/SPRINT_prerelease_2026-05-07.md`](../SPRINT_prerelease_2026-05-07.md)
...
- Onboarding (16 шагов) — **синяя палитра применена в pre-release sprint** (2026-05-07); структура и логика шагов остаются, отдельный спринт NEW-OB по FitnesBot
