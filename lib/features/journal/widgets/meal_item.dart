                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          _MacroPill(value: 'Б ${meal.protein.toStringAsFixed(0)}', color: AppColors.accent),
                          const SizedBox(width: 4),
                          _MacroPill(value: 'Ж ${meal.fat.toStringAsFixed(0)}', color: AppColors.warm),
                          const SizedBox(width: 4),
                          _MacroPill(value: 'У ${meal.carbs.toStringAsFixed(0)}', color: AppColors.support),
                        ],
                      ),
                    ],
                  ),
